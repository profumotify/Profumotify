...
// ============================================================
const familyStyles = {
  "Aromatico Acquatico": { color: "#00BCD4", icon: "\u{1F30A}" },
  "Orientale Acquatico": { color: "#0097A7", icon: "\u{1F30A}" },
  "Citrus Aromatico": { color: "#FF9800", icon: "\u{1F34A}" },
  "Orientale Legnoso": { color: "#795548", icon: "\u{1FAB5}" },
  "Aromatico Foug\u00e8re": { color: "#4CAF50", icon: "\u{1F33F}" },
  "Orientale Speziato": { color: "#E65100", icon: "\u{1F336}\uFE0F" },
  "Floreale Fruttato": { color: "#E91E63", icon: "\u{1F338}" },
  "Orientale Fruttato": { color: "#FF5722", icon: "\u{1F34E}" },
  "Floreale Acquatico": { color: "#03A9F4", icon: "\u{1F4A7}" },
  "Orientale Gourmand": { color: "#8D6E63", icon: "\u{1F36F}" },
  "Floreale Orientale": { color: "#F06292", icon: "\u{1F3A0}" },
  "Aromatico Legnoso": { color: "#6D4C41", icon: "\u{1F332}" },
  "Citrus Fruttato": { color: "#FFB300", icon: "\u{1F34B}" }
};
...
// ============================================================
const seasonData = {
  "Primavera": { icon: "\u{1F338}", color: "#F8BBD0", months: [3,4,5] },
  "Estate": { icon: "\u2600\uFE0F", color: "#FFF9C4", months: [6,7,8] },
  "Autunno": { icon: "\u{1F342}", color: "#FFE0B2", months: [9,10,11] },
...
// ============================================================
const bariWeather = {
  "Primavera": { temp: "18\u00b0C", humidity: "65%", condition: "Soleggiato", wind: "15 km/h", icon: "\u{1F324}\uFE0F" },
  "Estate": { temp: "28\u00b0C", humidity: "70%", condition: "Caldo", wind: "12 km/h", icon: "\u2600\uFE0F" },
  "Autunno": { temp: "20\u00b0C", humidity: "72%", condition: "Variabile", wind: "18 km/h", icon: "\u{1F325}\uFE0F" },
  "Inverno": { temp: "12\u00b0C", humidity: "75%", condition: "Fresco", wind: "20 km/h", icon: "\u{1F327}\uFE0F" }
};
