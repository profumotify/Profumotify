...
// ============================================================
// SISTEMA UTENTI / LOGIN
// ============================================================
const usersDB = {
  "giancarlo": { password: "bari2024", name: "Giancarlo", location: "Bari", collection: perfumeDB },
  "ospite": { password: "ospite", name: "Ospite", location: "Italia", collection: [] }
};
...
function loginUser(username, password) {
  ...
  if (user && user.password === password) {
    currentUser = user;
    localStorage.setItem('profumotify_user', username);
...
function logoutUser() {
  currentUser = null;
  localStorage.removeItem('profumotify_user');
}

function checkAutoLogin() {
  const saved = localStorage.getItem('profumotify_user');
  if (saved && usersDB[saved]) {
    currentUser = usersDB[saved];
    return true;
  }
  return false;
}
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { perfumeDB, noteCategories, familyStyles, seasonData, bariWeather, getWeatherRecommendation, collectionStats, usersDB, loginUser, logoutUser, checkAutoLogin, getCurrentUser };
}
